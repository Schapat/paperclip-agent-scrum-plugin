...
const manifest: PaperclipPluginManifestV1 = {
  ...
  capabilities: [
    ...
    // Damit beantwortet die Boardseite eine offene Rueckfrage direkt — auf
    // einen Klick des Humans hin, nie von selbst. Die Entscheidung wird dem
    // angemeldeten Board-Nutzer zugeschrieben, den der Host selbst aufloest;
    // ohne ihn lehnt die Aktion ab.
    //
    // Der Host stuft das als Rechteerweiterung ein und verlangt eine
    // ausdrueckliche Freigabe in den Plugin-Einstellungen. Ohne sie zeigt das
    // Board die Frage weiterhin an, sagt aber, dass geantwortet werden muss,
    // wo die Frage steht.
